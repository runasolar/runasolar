...
export const SERVICES = [
  ...
  {
    id: "business",
    title: "Сонячна електростанція для бізнесу",
    short: "СЕС бізнес",
    description:
      "Мережева станція допоможе зменшити витрати на електроенергію і швидко окупити інвестиції. Гібридна станція з акумуляторами забезпечить стабільну роботу підприємства навіть в умовах відключень мережі.",
    bullets: [
      "Гнучкий підхід, з'ясування Ваших потреб, надання технічного рішення для їх задоволення",
      "Швидка окупність інвестицій від 2 років",
      "Зменшення витрат на оплату електроенергії за комерційним тарифом",
      "Забезпечення безперервної роботи бізнесу і його виробничих процесів",
      "Можливість поєднання мережевих СЕС з вже наявними генераторами для економії пального при відключеннях",
    ],
  },
  {
    id: "storage",
