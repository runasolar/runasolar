        ...
        <div className="grid gap-10 pt-16 lg:grid-cols-12 lg:gap-12 lg:pt-20">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="mt-5 max-w-sm text-base text-bg/70 text-pretty">
              Будуємо сонячні станції для приватних будинків та бізнесу,
              постачаємо й монтуємо накопичувачі енергії, інвертори та
              системи автономного живлення — від консультації до запуску
              станції.
            </p>
