...
const HERO = {
  ...
  descriptionLead:
    "Компанія RUNA SOLAR будує сонячні електростанції, системи автономного живлення та накопичувачі енергії під ключ.",
  descriptionBody:
    "Побудуємо для Вас сонячні станції для приватних будинків та бізнесу, змонтуємо і запустимо установки зберігання енергії з нуля або під діючу СЕС. Повний перелік послуг — від консультації до запуску станції.",
};
