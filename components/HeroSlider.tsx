...
const HERO = {
  ...
  descriptionBody:
    "Будуємо сонячні станції для приватних будинків та бізнесу, постачаємо й монтуємо накопичувачі енергії, інвертори та системи автономного живлення — від консультації до запуску станції.",
};
